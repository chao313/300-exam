  ...
  methods: {
    ...
    fillSubmit() { //填空题提交
      ...
      this.$axios({
        ...
        this.$axios(`/300-exam/fillQuestionId`).then(res => { //获取当前题目的questionId
          let questionId = res.data.data.questionId
          this.postPaper.questionId = questionId
    ...
    judgeSubmit() { //判断题提交
      ...
      this.$axios({
        ...
        this.$axios(`/300-exam/judgeQuestionId`).then(res => { //获取当前题目的questionId
          let questionId = res.data.data.questionId
          this.postPaper.questionId = questionId
